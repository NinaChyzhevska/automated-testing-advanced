...
public class DashboardSteps {
    ...
    public void iAmLoggedInToTheReportPortal() {
    ...
    public void iCreateADashboardWithNameAndDescription(String name, String description) {
        expectedName = name;
    ...
    public void iDeleteDashboardById() {
    ...
    public void theDashboardIsNotFound() {
    ...
    public void addOneWidgetToTheNewestCreatedDashboard() {
    ...
    public void iCanSeeTheWidgetInTheDashboard() {
    ...
    public void iSearchTheDashboardByName() {
    ...
    public void iCanSeeThatTheDashboardIsPresentOnTheDashboardList() {
    ...
    public void theListWithResultsIsEmpty() {
